export const deApp = {
  ...
  dashboard: {
    previewActive: "Die Light-Vorschau ist aktiv. Änderungen sind deaktiviert.",
    paidMode: "Paid-Modus",
    previewLightMode: "Light-Modus ansehen",
    returnToPaidMode: "Zurück zum Paid-Modus",
    previewReadOnlyError: "Die Light-Vorschau ist schreibgeschützt. Wechsle zum Paid-Modus, um Änderungen vorzunehmen.",
    invite: {
      title: "Einladen",
    ...
    uploads: {
      ...
      yesterday: "Gestern",
      qualification: "Quali",
      pushupSet: "Liegestütze Set {index}",
      ...
      extraCategoryValue: "Kategoriewert",
    ...
    timeline: {
      ...
      searchLabel: "Workout-Verlauf durchsuchen",
      searchPlaceholder: "Datum, Notiz oder Kategorie",
      noSearchResults: "Keine Workouts passen zu dieser Suche.",
      ...
      confirmVideoDelete: "Dieses Video löschen? Das kann nicht rückgängig gemacht werden.",
      deleteRemovesClaim:
        "Wenn du das letzte Video l\u00f6schst, wird auch der Workout-Claim entfernt.",
      claimEdit: "Claim ändern",
      claimDelete: "Claim entfernen",
      confirmClaimDelete: "Diesen Workout-Eintrag entfernen? Das kann nicht rückgängig gemacht werden.",
      editableClaimHint:
    ...
    metastats: {
      ...
      emailUnverified: "E-Mail unbestätigt",
      emailVerifiedAt: "Bestätigt am {date}",
      emailVerificationHint:
        "Bestätige deine E-Mail-Adresse, damit Account-bezogene Mails sauber zugeordnet bleiben.",
    ...
    review: {
      ...
      noReviewerData: "Noch keine Reviewer",
      noPrimary: "Keine offenen Erstreviews.",
      noEscalation: "Keine offenen Pr\u00fcf-Reviews.",
      noSickness: "Keine offenen Krankmeldungen.",
      feedbackHistoryTitle: "Rückmeldungen zu deinen Reviews",
      noFeedbackHistory: "Noch keine Rückmeldungen zu deinen Reviews.",
      sicknessBody:
      ...
      stagePrimary: "Erstreview",
      stageArbitration: "Prüf-Review",
      claimPrefix: "Claim",
      targetPrefix: "Ziel",
      countsLabel: "z\u00e4hlt",
