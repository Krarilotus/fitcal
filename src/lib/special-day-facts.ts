export const DAILY_FACTS: Record<string, string> = {
  ...
  "01-02":
    "Am 2. Januar wirkt fast jede gute Entscheidung plötzlich unspektakulär, und genau das macht sie meist brauchbar.",
  "01-03":
    "Am 3. Januar fühlt sich der Jahresanfang oft noch nach Kaltstart an; umso besser für den Beweis, dass Routine auch ohne Glanz funktioniert.",
  "01-04":
    "Am 4. Januar ist Welt-Braille-Tag, also ein Datum für Zugänglichkeit, Klarheit und Dinge, die lesbar sein sollten.",
  "01-05":
    "Am 5. Januar passt Winterluft hervorragend zu einem sachlichen Plan: kalt draußen, klar im Kopf, keine Debatte.",
  "01-06":
    "Heilige Drei Könige zeigen, dass selbst Feiertage ein gutes Motiv für Haltung und ordentliche Schritte abgeben können.",
  "01-07":
    "Am 7. Januar erinnert die Kalenderlage daran, dass ein Jahr oft nicht mit Feuerwerk beginnt, sondern mit stiller Wiederholung.",
  "01-08":
    "Am 8. Januar ist Wintermorgen-Logik angesagt: Wer früh anfängt, hat dem inneren Widerstand schon halb die Bühne genommen.",
  "01-09":
    "Am 9. Januar ist der Feiertagsrest meist aufgebraucht, also beginnt jetzt der Teil des Jahres, der später nach echtem Fortschritt aussieht.",
  "01-10":
    "Am 10. Januar fühlt sich Disziplin oft noch etwas roh an; genau daraus werden später die angenehm langweiligen Gewohnheiten.",
  "01-11":
    "Am 11. Januar ist International Thank-You Day, ein guter Anlass, wenigstens dem eigenen zukünftigen Ich keinen Unsinn zu hinterlassen.",
  "01-12":
    "Am 12. Januar erinnert vieles an Haruki Murakami, also an Ausdauer, Rhythmus und erstaunlich präzise Wiederholung.",
  "01-13":
    "Am 13. Januar passt graues Winterlicht erstaunlich gut zu klaren Zahlen: wenig Drama, gute Sicht auf das Wesentliche.",
  "01-14":
    "Am 14. Januar liegt oft Frost in der Luft, und selbst der Kalender wirkt plötzlich wie jemand, der keinen weichen Handschlag mag.",
  "01-15":
    "Am 15. Januar wurde 2001 die Wikipedia gestartet, also ein schönes Datum für Leute, die Dinge lieber dokumentieren als nur behaupten.",
  "01-16":
    "Am 16. Januar ist Internationaler Tag der scharfen Küche, was nicht direkt Training ist, aber immerhin eine brauchbare Metapher für Körperspannung.",
  "01-17":
    "Am 17. Januar wurde Benjamin Franklin geboren, ein Mensch mit auffallender Begabung für Vernunft, Experiment und gute Listen.",
  "01-18":
    "Am 18. Januar kann der Winter ruhig etwas bissig sein; genau dann sehen einfache, erledigte Dinge besonders gut aus.",
  "01-19":
    "Am 19. Januar ist Popcorn Day in manchen Kalendern, aber die bessere Abendunterhaltung bleibt meist eine abgehakte Pflicht.",
  "01-20":
    "Am 20. Januar wird aus Januar langsam ein Belastungstest für Vorsätze, also genau die Phase, in der Struktur interessanter wird als Stimmung.",
  "01-21":
    "Am 21. Januar ist Weltknuddeltag, aber der Kalender akzeptiert als Zuneigung heute auch saubere Wiederholungen ohne Ausweichbewegung.",
  "01-22":
    "Am 22. Januar erinnert vieles an den Élysée-Vertrag und daran, dass gute Zusammenarbeit oft auf überraschend nüchterner Verlässlichkeit beruht.",
  "01-23":
    "Am 23. Januar ist Handwriting Day, also ein Datum für Handschrift, Spuren und alles, was später noch lesbar sein soll.",
  "01-24":
    "Am 24. Januar ist Internationaler Tag der Bildung; saubere Routinen fühlen sich selten spektakulär an, aber erstaunlich lehrreich.",
  "01-25":
    "Am 25. Januar passt trockene Winterluft gut zu trockener Wahrheit: Erledigt ist schöner als gut gemeint.",
  "01-26":
    "Am 26. Januar ist Australiens Nationalfeiertag, während der europäische Winter weiter zeigt, wer auch ohne Sommerlaune liefert.",
  "01-27":
    "Am 27. Januar ist Holocaust-Gedenktag, ein ernstes Datum, das Respekt und eine klare Haltung verdient.",
  "01-28":
    "Am 28. Januar ist Europäischer Datenschutztag, also ein guter Hinweis darauf, dass ordentlich geführte Daten selten eine schlechte Idee sind.",
  "01-29":
    "Am 29. Januar wirkt der Monat oft wie eine lange Gerade gegen Wind; genau solche Tage geben später der Statistik ihr Rückgrat.",
  "01-30":
    "Am 30. Januar erinnert vieles an Franklin D. Roosevelt und daran, dass politische Schwere nicht ohne Ausdauer zu haben ist.",
  "01-31":
    "Letzter Januartag: Monatsenden sind der Moment, in dem selbst Winterträgheit plötzlich nach Buchhaltung riecht.",
  "02-01":
    "Am 1. Februar ist der Winter noch klar im Amt, aber das Jahr wirkt zum ersten Mal, als könnte es wirklich Struktur annehmen.",
  "02-02":
    "Am 2. Februar ist Murmeltiertag, also die große Popkulturfeier der Wiederholung; für Routinen ist das fast schon Heimatfilm.",
  "02-03":
    "Am 3. Februar wurde in manchen Jahren Musikgeschichte geschrieben; heute reicht allerdings schon ein sauberer Rhythmus im eigenen Ablauf.",
  "02-04":
    "Am 4. Februar ist Weltkrebstag, ein Datum, das den Blick sehr direkt auf Gesundheit, Vorsorge und Ernsthaftigkeit lenkt.",
  "02-05":
    "Am 5. Februar klingt Winterluft oft wie ein stiller Kommentar: nicht jammern, warm werden, loslegen.",
  "02-06":
    "Am 6. Februar ist International Day of Zero Tolerance for Female Genital Mutilation, ein wichtiges Datum für klare Haltung und Menschenrechte.",
  "02-07":
    "Am 7. Februar wurden die Beatles in den USA endgültig zum Massenphänomen, also ein Datum mit auffällig viel Echo.",
  "02-08":
    "Am 8. Februar passt trockene Februarkälte erstaunlich gut zu nüchterner Konsequenz.",
  "02-09":
    "Am 9. Februar wurde die Boeing 747 offiziell vorgestellt und machte Größenordnungen plötzlich sehr anschaulich.",
  "02-10":
    "Am 10. Februar erinnert vieles an die Verleihung von Nelson Mandelas Freiheit im Jahr 1990, also an langen Atem mit Wirkung.",
  "02-11":
    "Am 11. Februar ist Internationaler Tag der Frauen und Mädchen in der Wissenschaft, ein erfreulich klares Plädoyer für Können und Zugang.",
  "02-12":
    "Am 12. Februar wirkt Februar oft wie ein kleiner Test auf Ehrlichkeit: Machst du die Sache noch, wenn das Neujahrsgefühl längst weg ist?",
  "02-13":
    "Am 13. Februar ist Weltradiotag, und gute Routinen erinnern manchmal an guten Funk: wenig Show, klare Signale.",
  "02-14":
    "Valentinstag: Ein erstaunlich brauchbarer Anlass, dem eigenen Körper mal mit Taten statt Grußkarten zu antworten.",
  "02-15":
    "Am 15. Februar ist International Childhood Cancer Day, ein Datum, das Mitgefühl und Demut sehr klar sortiert.",
  "02-16":
    "Am 16. Februar wurde Kyoto beschlossen, also ein Tag, an dem Regeln und Verantwortung einmal ziemlich global gedacht wurden.",
  "02-17":
    "Am 17. Februar fühlt sich der Winter häufig wie zäher Widerstand an; genau daraus macht eine Routine später Selbstverständlichkeit.",
  "02-18":
    "Am 18. Februar wurde Pluto entdeckt, was immerhin beweist, dass sich gründliches Hinschauen mitunter sehr lohnt.",
  "02-19":
    "Am 19. Februar ist ein guter Tag für die kleine Wahrheit, dass nicht Motivation zieht, sondern der nächste saubere Schritt.",
  "02-20":
    "Am 20. Februar ist Welttag der sozialen Gerechtigkeit, ein Datum mit erfreulich wenig Geduld für billige Ausreden.",
  "02-21":
    "Am 21. Februar ist Internationaler Tag der Muttersprache; heute darf also sogar der innere Monolog klar und ohne Beschönigung sein.",
  "02-22":
    "Am 22. Februar wurde 1732 George Washington geboren, und selbst ferne Staatsgründung klingt plötzlich nach viel Disziplin und wenig Bequemlichkeit.",
  "02-23":
    "Am 23. Februar merkt man dem Jahr an, dass es kein Vorsatz-Probemonat mehr ist.",
  "02-24":
    "Am 24. Februar ist der Winter oft noch rau genug, um jede erledigte Kleinigkeit fast schon heroisch aussehen zu lassen.",
  "02-25":
    "Am 25. Februar denkt der Kalender gelegentlich an Renoir; gute Linienführung bleibt also nicht nur in der Kunst ein Argument.",
  "02-26":
    "Am 26. Februar wurde der Grand Canyon zum Nationalpark, eine schöne Erinnerung daran, dass Tiefe meistens Zeit braucht.",
  "02-27":
    "Am 27. Februar ist International Polar Bear Day, also ein Datum mit ordentlich Eis im Hintergrund und wenig Verständnis für Bequemlichkeit.",
  "02-28":
    "Letzter Februartag: Ein kurzer Monat ist trotzdem lang genug, um aus Behauptungen Daten zu machen.",
  "02-29":
    "Schalttag: Der Kalender schenkt einen Extratag, und selten klang 'nicht verschenken' so angemessen.",
  "03-01":
    "Am 1. März riecht selbst kalte Luft schon ein bisschen nach Übergang, also nach genau der Sorte Neustart, die nicht laut sein muss.",
  "03-02":
    "Am 2. März erinnert vieles an Dr. Seuss, also an Fantasie, Rhythmus und sehr unterschiedliche Beziehungen zur Ernsthaftigkeit.",
  "03-03":
    "Am 3. März ist Tag des Artenschutzes; Schutz funktioniert dort wie Fortschritt hier: aufmerksam, konsequent, nicht nur dekorativ.",
  "03-04":
    "Am 4. März wirkt der Spätwinter oft wie eine sachliche Erinnerung daran, dass Wärme manchmal erst nach der Arbeit kommt.",
  "03-05":
    "Am 5. März ist Weltenergiespartag, aber ein bisschen eigene Energie zu investieren bleibt trotzdem ein fairer Deal.",
  "03-06":
    "Am 6. März fühlt sich das Jahr zum ersten Mal an, als ließe es sich nicht mehr mit Januar entschuldigen.",
  "03-07":
    "Am 7. März erinnert der Kalender auch an Maurice Ravel; Präzision kann also durchaus elegant aussehen.",
  "03-08":
    "Am 8. März ist Internationaler Frauentag, ein Datum für Sichtbarkeit, Rechte und klare Prioritäten.",
  "03-09":
    "Am 9. März passt frische Märzkälte gut zu nüchterner Einsicht: anfangen ist fast immer weniger dramatisch als aufschieben.",
  "03-10":
    "Am 10. März wurde 1876 das erste Telefongespräch geführt, also ein gutes Datum für direkte Verbindungen statt innerer Ausflüchte.",
  "03-11":
    "Am 11. März erinnert vieles an Fukushima, ein ernstes Datum über Technik, Risiko und Verantwortung.",
  "03-12":
    "Am 12. März fühlt sich der Frühling oft an wie ein Gerücht mit kalten Händen.",
  "03-13":
    "Am 13. März wirkt selbst dünne Märzsonne schon wie eine kleine Belohnung für Menschen, die nicht ewig verhandeln.",
  "03-14":
    "Am 14. März ist Pi-Tag, also ein Fest für Zahlenfreunde und für Menschen, die Wiederholung nicht nur als Last sehen.",
  "03-15":
    "Die Iden des März erinnern daran, dass selbst historische Dramen mit einem ganz normalen Datum anfangen.",
  "03-16":
    "Am 16. März wurde Robert Goddard geboren; Raketen und Trainingspläne teilen immerhin die Liebe zum kontrollierten Schub.",
  "03-17":
    "Am 17. März ist St. Patrick's Day, ein Datum mit viel Grün, guter Laune und erstaunlich wenig Einfluss auf deine Tageszahl.",
  "03-18":
    "Am 18. März erinnert Deutschland an Revolution, Bürgerrechte und daran, dass Haltung selten aus Bequemlichkeit entsteht.",
  "03-19":
    "Am 19. März ist März-Wetter oft halb Versprechen, halb Probe, und genau so fühlen sich gute Routinen an, bevor sie selbstverständlich werden.",
  "03-20":
    "Frühlingsanfang: Mehr Licht, weniger Ausreden, dieselbe ehrliche Mathematik.",
  "03-21":
    "Am 21. März treffen Welttag der Poesie und Internationaler Tag gegen Rassismus aufeinander, also Sprache, Haltung und Verantwortung dicht beieinander.",
  "03-22":
    "Am 22. März ist Weltwassertag, und die klarste Sache heute wäre trotzdem, nicht zu verwässern, was du dir vorgenommen hast.",
  "03-23":
    "Am 23. März ist Welttag der Meteorologie, ein schönes Datum für Leute, die Wetterlagen lesen und trotzdem nicht vom Wind abhängig sein wollen.",
  "03-24":
    "Am 24. März ist Welt-Tuberkulose-Tag, ein ernstes Gesundheitsdatum, das Aufmerksamkeit verdient.",
  "03-25":
    "Am 25. März wirkt der Frühling oft schon mutiger, aber der Kalender belohnt weiter eher Verlässlichkeit als großes Gerede.",
  "03-26":
    "Am 26. März zeigt dünner Sonnenschein gern, wie wenig man für einen etwas besseren Tag eigentlich braucht.",
  "03-27":
    "Am 27. März ist Welttheatertag; du brauchst heute trotzdem keine Dramaturgie, nur ordentliche Ausführung.",
  "03-28":
    "Am 28. März wurde Virginia Woolf geboren, was immerhin für Präzision, Rhythmus und einen gesunden Respekt vor Innenleben spricht.",
  "03-29":
    "Am 29. März ist die Übergangszeit fast immer meteorologisch leicht frech, also ein gutes Training gegen Stimmungsschwankungen.",
  "03-30":
    "Am 30. März ist der Monat fast geschafft, aber fast fertig ist weiterhin keine eigene Kategorie.",
  "03-31":
    "Letzter Märztag: Morgen beginnt ein neuer Monat, aber heute ist noch der perfekte Tag, um ohne großes Vorspiel sauber abzuschließen.",
  "04-01":
  ...
  "05-05":
    "Am 5. Mai liegen Europatag und Gleichstellungsfragen dicht beieinander, also ein Datum mit angenehm wenig Geduld für klein gedachte Systeme.",
  "05-06":
  ...
  "05-11":
    "Am 11. Mai darf mit Ionesco kurz Absurdität ins Bild, aber die Tageszahl bleibt erfreulich untheatralisch.",
  "05-12":
  ...
  "05-19":
    "Am 19. Mai reicht schon die kleine Wahrheit, dass selbst ziemlich technische Tage durch klare Abläufe sympathischer wirken.",
  "05-20":
    "Am 20. Mai ist Weltmetrologietag, also ein Fest für Menschen, die Messen nicht für eine Charakterfrage halten.",
  "05-21":
    "Am 21. Mai ist kulturelle Vielfalt das Stichwort, also ein guter Tag für Reichweite im Kopf und Schlichtheit in der Ausführung.",
  "05-22":
  ...
  "05-31":
    "Am 31. Mai darf der Monatsabschluss ruhig etwas Raumstationsenergie haben: nüchtern, präzise, kein unnötiger Lärm.",
  "06-01":
    "Am 1. Juni schwingt mit der Expo 2000 ein alter Zukunftsoptimismus mit, aber heute reicht schon eine brauchbare Gegenwart.",
  "06-02":
    "Am 2. Juni liegt einiges an deutscher Erinnerung übereinander, also kein Tag für große Show, eher für klare Haltung.",
  "06-03":
    "Am 3. Juni passt mit Chicago ein bisschen Bühnenrhythmus ins Bild, und gutes Timing bleibt auch außerhalb des Musicals nützlich.",
  "06-04":
  ...
  "06-15":
    "Am 15. Juni ist der Kalender eher fein als laut: Literatur, Erinnerung und Dinge, die erst im Rückblick Gewicht bekommen.",
  "06-16":
    "Am 16. Juni lohnt sich ein Blick auf Andrea Ghez, also auf Präzision, Ausdauer und ziemlich große Fragen ohne großes Getöse.",
  "06-17":
    "Am 17. Juni erinnert der Kalender in Deutschland an Aufstand, Freiheitssehnsucht und sehr konkrete politische Reibung.",
  "06-18":
    "Am 18. Juni erinnert ein Waffenstillstand von Algier daran, dass trockene Texte manchmal sehr konkrete Wirkung entfalten.",
  "06-19":
  ...
  "06-22":
    "Am 22. Juni darf kurz an James Horner gedacht werden; gute Dramaturgie ist schön, aber heute reicht ein sauberer Ablauf.",
  "06-23":
  ...
  "06-28":
    "Am 28. Juni klingt mit ITER kurz Zukunftslabor an, doch die brauchbarste Energiequelle bleibt heute saubere Disziplin.",
  "06-29":
  ...
  "07-01":
    "Am 1. Juli nahm der Internationale Strafgerichtshof seine Arbeit auf, also ein Datum für Regeln, die nicht nur auf Papier gut aussehen sollen.",
  "07-02":
    "Am 2. Juli passt mit Steve Fossett eine sehr spezielle Form von Ausdauer ins Bild: lang, einsam, erstaunlich präzise.",
  "07-03":
  ...
  "07-04":
    "Am 4. Juli wurde beim CERN aus langer Theorie ein ziemlich harter Befund, was auch für Training keine schlechte Richtung ist.",
  "07-05":
  ...
  "07-08":
    "Am 8. Juli hob Atlantis zum letzten Mal ab; selbst Abschlüsse dürfen also ein bisschen Schub haben.",
  "07-09":
  ...
  "07-11":
    "Am 11. Juli liegt mit Spaniens WM-Titel Sportgeschichte in der Luft, aber heute reichen schon zwei ordentliche Sätze ohne Finalpathos.",
  "07-12":
  ...
  "07-16":
    "Am 16. Juli erinnert der Kalender an einen gescheiterten Putsch auf São Tomé und Príncipe, also an einen eher harten Stoff für einen Sommertag.",
  "07-17":
  ...
  "07-18":
    "Am 18. Juli zeigt Detroit, wie lange Rechnungen liegen bleiben können, bis sie plötzlich sehr öffentlich werden.",
  "07-19":
  ...
  "07-23":
    "Am 23. Juli zieht mit Hale-Bopp kurz Himmelsmaterial vorbei, also ein schöner Anlass für etwas weniger Erdgebundenheit im Kopf.",
  "07-24":
  ...
  "07-27":
    "Am 27. Juli kommt London-2012-Energie auf: etwas Glanz ist erlaubt, solange die Ausführung nicht darunter leidet.",
  "07-28":
  ...
  "07-30":
    "Am 30. Juli erinnert das Pretoria-Abkommen daran, dass selbst festgefahrene Lagen irgendwann einen nüchternen Ausweg brauchen.",
  "07-31":
