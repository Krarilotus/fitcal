...
export function PreferenceControls({
  ...
  return (
    <div className="flex items-center gap-1.5 text-xs text-[var(--fc-muted)]">
      <label className="flex items-center gap-1" title={labels.locale}>
        ...
        <select
          className="fc-input h-7 w-auto min-w-0 py-0 px-1.5 text-xs"
      ...
      <label className="flex items-center gap-1" title={labels.theme}>
